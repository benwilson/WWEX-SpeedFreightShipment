<?php
/**
 * File for SpeedFreightShipmentWsdlClass to communicate with SOAP service
 ...
 */
/**
 * SpeedFreightShipmentWsdlClass to communicate with SOAP service
 * 
 * @package SpeedFreightShipment
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-01-04
 */
class SpeedFreightShipmentWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
    ...
    /**
     * Constructor
     * @uses SpeedFreightShipmentWsdlClass::setLastError()
     * @uses SpeedFreightShipmentWsdlClass::initSoapClient()
     * @uses SpeedFreightShipmentWsdlClass::initInternArrayToIterate()
     * @uses SpeedFreightShipmentWsdlClass::_set()
     ...
     * @return SpeedFreightShipmentWsdlClass
     */
     ...
     * @return SpeedFreightShipmentWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'SpeedFreightShipmentWsdlClass'))
            {
     ...
     * @uses SpeedFreightShipmentClassMap::classMap()
     * @uses SpeedFreightShipmentWsdlClass::getDefaultWsdlOptions()
     * @uses SpeedFreightShipmentWsdlClass::getSoapClientClassName()
     * @uses SpeedFreightShipmentWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('SpeedFreightShipmentClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = SpeedFreightShipmentClassMap::classMap();
     ...
     * If a class is named as {SpeedFreightShipment}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('SpeedFreightShipmentSoapClient') && is_subclass_of('SpeedFreightShipmentSoapClient','SoapClient'))
            return 'SpeedFreightShipmentSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses SpeedFreightShipmentWsdlClass::WSDL_CACHE_WSDL
     * @uses SpeedFreightShipmentWsdlClass::WSDL_COMPRESSION
     * @uses SpeedFreightShipmentWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses SpeedFreightShipmentWsdlClass::WSDL_ENCODING
     * @uses SpeedFreightShipmentWsdlClass::WSDL_EXCEPTIONS
     * @uses SpeedFreightShipmentWsdlClass::WSDL_FEATURES
     * @uses SpeedFreightShipmentWsdlClass::WSDL_LOGIN
     * @uses SpeedFreightShipmentWsdlClass::WSDL_PASSWORD
     * @uses SpeedFreightShipmentWsdlClass::WSDL_SOAP_VERSION
     * @uses SpeedFreightShipmentWsdlClass::WSDL_STREAM_CONTEXT
     * @uses SpeedFreightShipmentWsdlClass::WSDL_TRACE
     * @uses SpeedFreightShipmentWsdlClass::WSDL_TYPEMAP
     * @uses SpeedFreightShipmentWsdlClass::WSDL_URL
     * @uses SpeedFreightShipmentWsdlClass::VALUE_WSDL_URL
     * @uses SpeedFreightShipmentWsdlClass::WSDL_USER_AGENT
     * @uses SpeedFreightShipmentWsdlClass::WSDL_PROXY_HOST
     * @uses SpeedFreightShipmentWsdlClass::WSDL_PROXY_PORT
     * @uses SpeedFreightShipmentWsdlClass::WSDL_PROXY_LOGIN
     * @uses SpeedFreightShipmentWsdlClass::WSDL_PROXY_PASSWORD
     * @uses SpeedFreightShipmentWsdlClass::WSDL_LOCAL_CERT
     * @uses SpeedFreightShipmentWsdlClass::WSDL_PASSPHRASE
     * @uses SpeedFreightShipmentWsdlClass::WSDL_AUTHENTICATION
     * @uses SpeedFreightShipmentWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses SpeedFreightShipmentWsdlClass::getSoapClient()
     * @uses SpeedFreightShipmentWsdlClass::getFormatedXml()
     ...
     * @uses SpeedFreightShipmentWsdlClass::getSoapClient()
     * @uses SpeedFreightShipmentWsdlClass::convertStringHeadersToArray()
     ...
     * @uses SpeedFreightShipmentWsdlClass::count()
     * @return int
     */
     ...
     * @uses SpeedFreightShipmentWsdlClass::getInternArrayToIterate()
     * @uses SpeedFreightShipmentWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses SpeedFreightShipmentWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses SpeedFreightShipmentWsdlClass::getInternArrayToIterateOffset()
     * @uses SpeedFreightShipmentWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses SpeedFreightShipmentWsdlClass::getInternArrayToIterateOffset()
     * @uses SpeedFreightShipmentWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see SpeedFreightShipmentWsdlClass::offsetGet()
     * @uses SpeedFreightShipmentWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses SpeedFreightShipmentWsdlClass::getAttributeName()
     * @uses SpeedFreightShipmentWsdlClass::__toString()
     * @uses SpeedFreightShipmentWsdlClass::_set()
     * @uses SpeedFreightShipmentWsdlClass::_get()
     * @uses SpeedFreightShipmentWsdlClass::setInternArrayToIterate()
     * @uses SpeedFreightShipmentWsdlClass::setInternArrayToIterateIsArray()
     * @uses SpeedFreightShipmentWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses SpeedFreightShipmentWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses SpeedFreightShipmentWsdlClass::item()
     * @uses SpeedFreightShipmentWsdlClass::length()
     * @return mixed
     */
